(function() {
    ...
    // --- CONFIGURATION API ---
    // Architecture Monolithe : Frontend et Backend sur le même domaine.
    // On utilise des chemins relatifs (chaîne vide), le navigateur utilisera automatiquement l'origine actuelle.
    const API_URL = '';
    const SOCKET_URL = '';
    ...
    function connectSocket() {
        ...
        // En ne passant pas d'URL (premier argument), Socket.io se connecte automatiquement à l'origine actuelle (window.location)
        socket = io({
